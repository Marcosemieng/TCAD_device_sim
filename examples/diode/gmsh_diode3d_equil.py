...
write_devices(file="gmsh_diode3d_equil.dat", type="vtk") # Paraview compatible
write_devices(file="gmsh_diode3d_equil_dd.dat", type="vtk") # Paraview compatible
write_devices(file="gmsh_diode3d_equil_out.dat", type="vtk") # Paraview compatible
