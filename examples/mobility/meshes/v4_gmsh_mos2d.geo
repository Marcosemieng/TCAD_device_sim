//// Mesh MOSFET 2D: v4
//// 1) oxide thickness = 10 nm; 2) diffusion thickness = 10 nm
//// 3) device width = 10 um; 4) channel length = 1 um
//// 5) Bulk thickness = 10 um; 

device_width =     10.0e-4;
gate_width =       1.0e-4;
diffusion_width =  0.4;
